...
- Distinguished an outdated Zotero plugin from an outdated Chrome companion in
  the Chrome extension's compatibility warning.
- Added Zotero-specific recovery instructions: open **Tools → Plugins**, open
  the gear menu, and choose **Check for Updates**.
- Allowed Chrome companion v0.3.2 as well as v0.3.3 with the v0.3.3 Zotero
